...
if (isset($_POST['submit'])) {
    ...
    if ((($_FILES["imgUrl"]["type"] == "image/gif") || ($_FILES["imgUrl"]["type"] == "image/jpeg") || ($_FILES["imgUrl"]["type"] == "image/jpg") || ($_FILES["imgUrl"]["type"] == "image/pjpeg") || ($_FILES["imgUrl"]["type"] == "image/x-png") || ($_FILES["imgUrl"]["type"] == "image/png")) && ($_FILES["imgUrl"]["size"] < 20000000000000) && in_array($extension, $allowedExts)) {
        if ($_FILES["imgUrl"]["error"] > 0) {
            ...
            if (file_exists("../images/questionImg/" . $_FILES["imgUrl"]["name"])) {
                echo $_FILES["imgUrl"]["name"] . " already exists. ";
            } else {

                move_uploaded_file($_FILES["imgUrl"]["tmp_name"], "../images/questionImg/" . $_FILES["imgUrl"]["name"]);

                $imgUrl = "images/questionImg/" . $_FILES["imgUrl"]["name"];
                $imgUrl = str_replace("/" , utf8_encode("/") , $imgUrl);
...
<html>
    ...
    <body>
        ...
        <form method="post" action="index.php" enctype="multipart/form-data">
            ...
            Antwoord1: <input type="text" name="antwoord1"><br>
            <div class='meerdere'>
                Antwoord2: <input type="text" name="antwoord2"><br>

                Antwoord3: <input type="text" name="antwoord3"><br>

                Antwoord4: <input type="text" name="antwoord4"><br>
